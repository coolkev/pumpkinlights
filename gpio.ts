...
export class Pin extends events.EventEmitter {
    ...
    public setDirection(dir: PinDirection, callback: () => void) {
        ...
        fs.readFile(this.path.direction, "utf-8", (err, data) => {
    ...
    public open(dir: PinDirection, callback: () => void) {
        ...
        if (fs.exists(this.path.pin)) {
            ...
            var onFail = (err) => {
                ...
                this.close(() => {
                    ...
                    writeFile(gpiopath + 'export', this.pinNum, onSuccess);
    ...
    public write(value: boolean, callback?: () => void) {
